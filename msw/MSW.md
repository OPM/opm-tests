...
----------------- | ------------------------------------------------------------  | ---------- | ----- |------- | ------------------------------------- |
MSW-2D-HZ         | Base model to test a production multi-segment horizontal well (PROD01) in a 2D grid.                | MSW-2D  | Reg | Yes        | Perfect match with commercial simulator up to 2020 and then water production diverges.
MSW-2D-HZ-01      | Error checking test, original test with errors in E100                                              | MSW-2D  |     | No         | OPM Flows runs with no warnings.<br /><br /> E100 stops with errors "SEGMENT   5 IN WELL PROD01   HAS A LENGTH <OR= 0" etc.
...
MSW-3D-04         | Error checking test, missing all COMPDAT connections.                                               | MSW-3D  |     | No, but OK | OPM Flow stops with "Error: Problem with keyword WELSEGS - Missing COMPSEGS keyword" <br /><br /> E100 runs with multiple warnings "NO CONNECTIONS WITH THE GRID".
MSW-3D-05         | Error checking test, missing all COMPSEGS connections.                                              | MSW-3D  |     | Yes        | OPM Flow stops with "Error: Problem with keyword WELSEGS - Missing COMPSEGS keyword" <br /><br /> E100 stops with error "NOT ALL CONNECTIONS ASSIGNED TO WELL SEGMENTS".
...
[MSW-2D-HZ ECL Results](plots/MSW-2D-HZ-ECL.md)
